...
def plot_erdosrenyi_coloring(eigvals, eigvects, graph_params, ax=None, nplots=4):
    ...
    for i in range(2, nplots+2):
        ...
        plt.savefig("./figs/erdosrenyi_coloring/eigvect_ " + str(i-1) + ".png")

def plot_erdosrenyi_embedding(eigvals, eigvects, graph_params, ax=None, maxindex=5, t=0):
    if ax is None:
        fig = plt.figure()
        ax = fig.add_subplot(111)
...
if __name__=="__main__":
    ...
    if args.degree_dist:
        ...
        for infile in args.input_files:
            ...
            if "graphparams" in infile:
                graph_params = uf.get_data(infile, header_rows=0)
        plot_erdosrenyi_embedding(eigvals, eigvects, graph_params)
        ...
        for infile in args.input_files:
            ...
            if "graphparams" in infile:
                graph_params = uf.get_data(infile, header_rows=0)
        plot_erdosrenyi_coloring(eigvals, eigvects, graph_params)
